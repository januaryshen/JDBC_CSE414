...
public class Query {
  ...
  private static final String GET_RES_PAID = "SELECT * FROM Reservations WHERE rid = ? AND paid = 0 AND cancelled = 0;";
  ...
  // Jan: reservation
  private static final String GET_RES_USER = "SELECT * FROM Reservations WHERE username = ? AND cancelled = 0;";
